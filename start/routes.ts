...
if (useSubdomains) {
  ...
  router
    .group(() => {
      ...
      router
        .patch('roles/:id/features', [controllers.Roles, 'updateFeatures'])
        .as('admin.roles.updateFeatures')
      ...
      router
        .get('campaigns', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Campanhas' })
        )
        .as('admin.campaigns')
      router
        .get('campaigns/create', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Criar Campanha' })
        )
        .as('admin.campaigns.create')
      router
        .get('settings', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Configurações' })
        )
        .as('admin.settings')
  ...
  router
    .group(() => {
      ...
      router
        .get('company', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Dados da Empresa' })
        )
        .as('tenant.company')
      router
        .get('company/edit', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Editar Empresa' })
        )
        .as('tenant.company.edit')
      router
        .get('company/addresses', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Endereços' })
        )
        .as('tenant.company.addresses.list')
      router
        .get('company/addresses/create', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Novo Endereço' })
        )
        .as('tenant.company.addresses.create')
      router
        .get('campaigns', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Campanhas' })
        )
  ...
  router
    .group(() => {
      ...
      router
        ...
        .as('company.addresses.list')
      router
        .get('company/addresses/create', ({ inertia }) =>
          inertia.render('placeholder', { featureName: 'Novo Endereço' })
        )
        .as('company.addresses.create')
...
if (useSubdomains) {
  ...
  router
    .get('/workspace', [controllers.Session, 'workspace'])
    .as('workspace.fallback')
    .use(middleware.auth())
}
